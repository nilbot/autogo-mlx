...
def main():
    print("🔬 TESTING ITER5 ON MOVE 1 BOARD...")
    
    board = GoBoard(9)
    board.play(8, 3) # Black plays at (8,3)
    
    checkpoint_path = "/Users/nilbot/playground/autogo-mlx/experiments/001_train_from_scratch/checkpoints/iter5.safetensors"
