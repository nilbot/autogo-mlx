...
def main() -> None:
    parser = argparse.ArgumentParser(description="Mugo Phase 10 Random Self-play Collector")
    parser.add_argument("--num-games", type=int, default=1000, help="Number of games to collect")
    parser.add_argument("--save-dir", type=str, default=None, help="Where to save games")
    ...
    print(f"Config: num-games={args.num_games}, workers={args.num_workers}, seed={args.seed}", flush=True)
